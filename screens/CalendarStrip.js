...
class DateItem extends React.Component {
  ...
  render() {
    ...
    const normalBgColor = ""+colors.back;
          ...
          <View style={[
            ...
            {marked &&
              <View style={[
                ...
                {backgroundColor: highlight ? 'white' : 'red'}
              ]} />
            }
          </View>
        </TouchableOpacity>
...
class CalendarStrip extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  _renderHeader = () => {
    ...
    const dateFormatted_en = format(selectedDate, 'DD/MM/YYYY   dddd');
    const dateFormatted = dateFormatted_en;
    const weekNumber = getISOWeek(selectedDate);
    return (
      <View style={[styles.header]}>
        <Text style={[styles.headerDate,{fontWeight:'bold',color:colors.text}]}>{dateFormatted}</Text>
        {showWeekNumber &&
          <Text style={[styles.headerDate,{fontWeight:'bold',color:colors.text}]}>{`  Week : ${weekNumber} `}</Text>
        }
  ...
  render() {
    ...
    return (
      <View style={[styles.container,{backgroundColor:colors.back}]} {...this._panResponder.panHandlers}>
        {this._renderHeader()}
